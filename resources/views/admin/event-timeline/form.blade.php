                            ...
                            <form id="tag-form" method="POST" action="{!! $form['action'] !!}"
                                ...
                                <fieldset>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="content">Attendance</label>
                                                <select onchange="showCode()" name="attendance" id="attendance" class="form-control">
                                                    <option value="" >Select Attendance</option>
                                                    <option value="No" {!! matchSelected("No", $data->attendance ?? '') !!}>No</option>
                                                    <option value="Yes" {!! matchSelected("Yes", $data->attendance ?? '') !!}>Yes</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        @else
                                        <div class="col-md-6 show-code" style="display:none;" >
                                            <div class="form-group">
                                                <label for="content">Code</label>
                                                <input readonly type="text" id="code" name="code"
                                                       value="{{ old('code', $data->code) }}" class="form-control">
